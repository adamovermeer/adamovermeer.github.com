(function(){
    ...
    window.addEventListener('load', function(){
        ...
        alert('Hi, and welcome to my final project user testing!\n\nThis site is an exhibition of a protography project I call "Under the same sky".\n\nPlease look through the photos, and explore the site :)');
